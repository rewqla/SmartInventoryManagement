...
public class GraphQLServiceSetup : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        var services = new ServiceCollection()
            ...
            .AddScoped<IReportGenerator<WarehouseDTO>, WarehouseReportGenerator>()
    ...
    private async Task SeedDataAsync(InventoryContext dbContext)
    {
        if (!dbContext.Warehouses.Any())
        {
            var warehouses = new List<Warehouse>
            {
                ...
                new Warehouse
                {
                    Id = Guid.Parse("4e9ae812-9308-41e7-aaa5-32379c4c2b3d"), Name = "Warehouse C", Location = "Berlin"
                },
                new Warehouse
                {
                    Id = Guid.Parse("862038bf-9363-4552-92e8-2f05e9b2fe9e"), Name = "Warehouse D", Location = "Tokyo"
                },
                new Warehouse
                {
                    Id = Guid.Parse("697f1876-2cbd-4c1e-a075-7554fe1977bc"), Name = "Warehouse E", Location = "London"
                },
